...
exports.buildWeeklySplit = buildWeeklySplit;
 ...
 */
function buildWeeklySplit(goal, days) {
    ...
    if (!base) {
        ...
        throw new workoutErrors_1.WorkoutEngineError("invalid_frequency", `No split defined for ${days} days/week.`);
    }
    const strategy = (0, goals_1.getGoalStrategy)(goal);
